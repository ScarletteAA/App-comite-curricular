...
const Homes =()=>{
    ...
    const addChange = (type: string, description: string) => {
        const newChange: Change = {
          id: uuidv4(), // Puedes usar una biblioteca como `uuid` para generar un identificador único
          type,
          description,
          date: new Date(),
        };
            ...
            <div id="nav" className="w-full px-6">
                <a href="#" className="w-full px-2 inline-flex space-x-2 items-center border-b border-slate-700 py-3 bg-blue-800 hover:bg-white/5 transition ease-linear duration-150">
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-sm text-white/50 hidden md:block">por carrera</span>
                    </div>
                </a>
